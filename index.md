...
<section id="contact" class="contact-section" style="padding: var(--spacing-xxl) 0; background-color: var(--color-m-primary); color: var(--color-light-text); text-align: center;">
  <div class="container-narrow">
    <h2 style="color: var(--color-add-acc); margin-bottom: var(--spacing-md);">Готовы обсудить ваш проект?</h2>
    <p style="font-size: var(--font-size-lg); margin-bottom: var(--spacing-lg); opacity: 0.9;">
      Забронируйте 45-минутную консультацию для анализа вашей ситуации и разработки плана действий
    </p>
    <a href="mailto:ymike@mail.ru" class="btn btn-primary" style="font-size: var(--font-size-lg); padding: var(--spacing-md) var(--spacing-lg);">
